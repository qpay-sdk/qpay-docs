...
| [Spring Boot](/frameworks/spring-boot) | `qpay-spring-boot-starter` | [Maven Central](https://central.sonatype.com/artifact/mn.qpay/qpay-spring-boot-starter) | Java | qpay-java |
